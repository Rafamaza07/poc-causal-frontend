...
import {
  ...
  Bell, TrendingUp, Users, Calculator,
} from 'lucide-react'
import { trackEvent } from '../../utils/analytics'

// H1 copy — fácil de cambiar aquí si comercial pide ajuste
const HERO_TITLE = 'Las incapacidades prolongadas mal gestionadas se convierten en pérdidas millonarias.'
          ...
          <div>
            ...
            <div className="inline-flex items-center gap-2 mb-6 animate-slide-up" style={{ animationDelay: '0ms' }}>
              ...
              >
                ...
                Gestión médico-legal sin vacíos documentales
            ...
            {/* Heading — copy de dolor, estático */}
            <h1
              className="text-4xl sm:text-5xl lg:text-[3.2rem] font-extrabold text-white leading-[1.1] tracking-tight mb-5 animate-slide-up font-display"
            ...
            >
              KausalIA las convierte en rutas trazables y accionables, reduciendo el tiempo de gestión de meses a días.
              Controla la gestión documental, detecta los vacíos que extienden o pierden los casos y optimiza los tiempos
              para mejorar la calificación de invalidez.
            </p>

            <div
              className="flex flex-col sm:flex-row gap-3 mb-3 animate-slide-up"
            ...
            >
              ...
              <button
                onClick={() => {
                  trackEvent('landing_hero_cta_click', { cta: 'costo_real' })
                  document.getElementById('costo-real')?.scrollIntoView({ behavior: 'smooth' })
                }}
              ...
              >
                <Calculator className="w-4 h-4 text-white/60" /> Calcula cuánto estás perdiendo
              </button>
            </div>
            ...
            >
              {['Cumple Ley 1581', 'Trazabilidad inmutable', 'Control de acceso por rol', 'MUCI + CIE-10 integrado'].map(t => (
          ...
          <div className="relative hidden lg:block animate-fade-in" style={{ animationDelay: '200ms' }}>
            ...
            >
              <div className="flex items-center gap-1.5 mb-1">
                ...
                <div className="text-xs font-bold text-gray-900">Sustento normativo activo</div>
              </div>
              ...
              <div className="flex bg-gray-950" style={{ minHeight: '360px' }}>
                ...
                <div className="w-40 bg-gray-900 flex-shrink-0 p-3">
                  ...
                  {[
                    ...
                    { label: 'Nuevo caso',  icon: FileText,    active: true },
                ...
                <div className="flex-1 p-4 overflow-hidden">
                  ...
                  <div className="grid grid-cols-2 gap-2 mb-3">
                    {[
                      { label: 'Diagnóstico',  value: 'M54.5 — Lumbago' },
                  ...
                  <div className="bg-emerald-500/10 border border-emerald-500/20 rounded-xl overflow-hidden">
                    <div className="flex items-center justify-between px-3 py-2 border-b border-emerald-500/20">
                      <span className="text-[10px] font-bold text-emerald-300 flex items-center gap-1">
                        <CheckCircle className="w-3 h-3" /> Ruta médico-legal lista
                      </span>
